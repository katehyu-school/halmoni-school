...
| 앱 | 현재 상태 | 다음 작업 |
|----|---------|---------|
| **HQ (nhs.html)** | L1 ep01~12 완성 ✅ / L2 ep01~12 완성 ✅ / **L1·L2 문법 annotation 툴팁 완성 ✅** / **L3 ep01~12 완성 ✅** / **L3 마감 테스트 완성 ✅** / **L4 ep01~12 완성 ✅** / **L4 마감 테스트 완성 ✅** | TOPIK 3-4 문법 커버리지 감사에서 발견된 L5 갭 정리 (피동/사동, -(으)ㄴ가/나 보다 등) |
...
> ✅ **2026-07-13 TOPIK 3-4 문법 커버리지 감사 결과**: L1~L4 전체 문법카드 title을 훑어본 결과, -잖아요/-거든요/-는 바람에/-(으)ㄹ 뻔하다/-기 마련이다/-는 한/-기 십상이다 등 주요 TOPIK 3-4 패턴은 이미 잘 커버됨. **다만 다음은 아직 전용 문법카드로 다룬 적 없음 — L5 후보**: 피동·사동 표현(이/히/리/기/우/구/추, -게 하다 — 우선순위 높음, TOPIK 3-4 단골 주제인데 아직 없음), -(으)ㄴ가/나 보다(추측), -았/었더니, -(으)ㄹ까 봐, -는 김에, -기는요, -는 대신에, -(으)ㄴ/는 데다가, -는 반면에. (참고: 2026-07-04 메모에 "-는 김에/피동·사동은 이미 다뤘다"는 기록이 있었는데, 이번에 실제 데이터로 재확인해보니 부정확했음 — 해당 메모는 폐기하고 이 결과로 대체.)
...
1. **HQ Level 5 커리큘럼 기획** — TOPIK 3-4 문법 감사에서 나온 갭(피동/사동, -(으)ㄴ가/나 보다, -았/었더니, -(으)ㄹ까 봐, -는 김에, -기는요, -는 대신에 등) 근거로 레벨5 vs 5+6 분량 판단
