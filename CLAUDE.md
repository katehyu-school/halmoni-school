...
| 앱 | 현재 상태 | 다음 작업 |
|----|---------|---------|
| **HQ (nhs.html)** | L1 ep01~12 완성 ✅ / L2 ep01~12 완성 ✅ / **L1·L2 문법 annotation 툴팁 완성 ✅** / **L3 ep01~12 완성 ✅** / **L3 마감 테스트 완성 ✅** / **L4 ep01~12 완성 ✅** / **L4 마감 테스트 완성 ✅** / **L5 ep01~02 완성 ✅** | L5 ep03+ 스크립트 준비되면 진행 |
...
| 02 | 🏠 남성전용 고시원 | 숙소 정하기 | -(으)ㄹ까 봐★NEW(L5 확정 갭), -(으)ㄹ 줄이야★NEW, -기는 하다★복습(L3 ep11), -대★복습(L3 ep08) | ✅ 완성 |
...
1. **HQ Level 5 ep03+** — ep01(삼총사의 첫 만남)·ep02(숙소 정하기) 완성, 스크립트 준비되면 진행. 남은 확정 문법 갭은 -(으)ㄴ가/나 보다, -았/었더니, -기는요 3개(-(으)ㄹ까 봐는 ep02에서 소진) — ep가 쌓이면 5 단독 vs 5+6 분량 재판단.
