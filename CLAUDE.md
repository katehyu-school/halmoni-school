...
> — **L3~L6 발음(`<발음>`) 탭 형식 통일**: L4 ep01~07의 표(table) 형식을 기준으로 L4 ep08~12·L5 전 12편·L6 전 12편의 발음 탭을 전부 동일 구조로 재작성(총 29개 파일).
