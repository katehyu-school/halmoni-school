...
| 앱 | 현재 상태 | 다음 작업 |
|----|---------|---------|
| **HQ (nhs.html)** | L1~L4 ep전체+마감테스트 완성 ✅ / **L5 ep01~12 완성 ✅ (대단원)** / **L5 마감 테스트 완성 ✅** / **쓰기 기능 파일럿 ✅** (받아쓰기 L3+자동·문장완성 L5전편·가이드작문 ep12만) / **마감테스트 듣기 녹음 연결 ✅** | L4·L3 문장완성 확장 / 가이드작문 ep12→타편 확산 / L6(드라마·뉴스) 미정 |
